...
class establishment(models.Model):
    ...
    type = fields.Selection([('winecellar','Winecellar'), ('restaurant','Restaurant'),('lodging','Lodging'),('cultural','Art and Culture'),('winebar','Winebar'), ('vinhedo','Viñedo'),('other','Other')],'Establishment Type', translate=True, required=True)    
